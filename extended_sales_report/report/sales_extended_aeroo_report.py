...
class Parser(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        ...
        self.localcontext.update({
            ...
            'get_labor_factor' : self.get_labor_factor,
        })
    ...
    def get_record(self, quantity, uom):
        return int(quantity),(uom.name)
    
    def get_labor_factor(self, labor_factor1):
        self.labor_factor += labor_factor1
        return labor_factor1